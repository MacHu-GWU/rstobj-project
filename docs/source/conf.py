# -*- coding: utf-8 -*-
#
# rstobj documentation build configuration file, created by
...
version = rstobj.__version__
# The full version, including alpha/beta/rc tags.
release = rstobj.__version__
...
html_logo = "./_static/rstobj-logo.png"
html_favicon = "./_static/rstobj-favicon.ico"
...
latex_documents = [
    (master_doc, 'rstobj.tex', 'rstobj Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'rstobj', 'rstobj Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rstobj', 'rstobj Documentation',
     author, 'rstobj', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from rstobj.docs import doc_data
except:
    doc_data = dict()
